...
export const CreateBook = () => {
  ...
  return (
    <form
      ...
      onSubmit={onCreate}
    >
      <h3 className="text-2xl font-medium leading-10 text-center">
        Create New Book
      </h3>
      <label className="block mt-8 text-base font-medium" htmlFor="title">
        Title
      </label>
      <input
        ...
        name="title"
      />
      <label className="block mt-8 text-base font-medium" htmlFor="description">
        Description
      </label>
      <textarea
        ...
        name="description"
      />
      <label className="block mt-8 text-base font-medium" htmlFor="image">
        Image Url
      </label>
      <input
        className="block h-12 w-full bg-indigo-400 rounded-sm px-3 mt-2 text-sm"
        ...
        name="image"
      />
      <label className="block mt-8 text-base font-medium" htmlFor="type">
        Type
      </label>
      <input
        className="block h-12 w-full bg-indigo-400 rounded-sm px-3 mt-2 text-sm"
